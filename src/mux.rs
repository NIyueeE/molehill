...
/// - split send size = 16 KiB (the vendored default; a 32 KiB experiment
///   measured -19%/-31% on the loopback cells for +4% on `loss1_rtt10` —
///   see HANDOFF.md, "Phase 3 reverted")
#[derive(Debug, Clone)]
pub struct Config {
